...
def initprobe():
    ...
    global source_ID
    usgfw2_0 = cdll.LoadLibrary(r'C://Users//CAMES VR 3//Downloads//ArtUs_RFDataControl_for-MATLAB_Python_LabVIEW//usgfw2wrapper.dll')
...
def recordloop():
    ...
    for i in range(0,50):
        ...
        img.convert('P').save(str(i)+"_old.png")
        if i % 10 == 0: print(i)
...
def processall():
    processdir = r"C:\\Users\\CAMES VR 3\\Downloads\\PathoSonic V1\\PathoSonic V1\\"
    ...
    for file in os.listdir(processdir):
        ...
        try:
            if file.endswith("npy"):
                ...
                im2.convert('P').save(processdir + os.sep + file.split(".")[0]+"_IMCONV.png")
